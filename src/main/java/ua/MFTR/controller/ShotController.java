...
import ua.MFTR.javaclass.domain.ResultShot;
import ua.MFTR.javaclass.domain.SourceShot;
import ua.MFTR.javaclass.servisClass.AlertAndInform;
import ua.MFTR.javaclass.servisClass.InputDate;
import ua.MFTR.javaclass.servisClass.OpenStage;
import ua.MFTR.javaclass.servisClass.SaveToExcelShot;
...
import static ua.MFTR.controller.Controller.localZone;
import static ua.MFTR.javaclass.servisClass.FileChooserRun.selectedOpenFile;
import static ua.MFTR.javaclass.servisClass.NormalisedShot.resultBulkShot;
...
public class ShotController implements Initializable {
    ...
    public void openData() throws Exception {
        ...
        labelGMT.setText("Часовий пояс - " + localZone);
